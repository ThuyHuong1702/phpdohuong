...
Route::get('variations/{id}', [VariationController::class, 'showVariants'])->name('admin.variations.showVariants');
...
Route::delete('variations/{ids}', [VariationController::class, 'delete'])->name('admin.variations.delete');

Route::get('variations/index/table', [VariationController::class, 'table'])->name('admin.variations.table');

Route::post('variations/delete', [VariationController::class, 'delete'])->name('admin.variations.delete');
